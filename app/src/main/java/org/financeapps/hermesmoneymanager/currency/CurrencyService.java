...
import org.financeapps.hermesmoneymanager.datalayer.CurrencyRepositorySql;
...
import org.financeapps.hermesmoneymanager.servicelayer.ServiceBase;
...
//                result = String.format("%.2f", value);
    ...
    public java.util.Currency getSystemDefaultCurrency() {
        ...
        Locale defaultLocale = hmmApplication.getApp().getAppLocale();
