...
package org.financeapps.hermesmoneymanager.about;
...
//        build = core.getAppVersionBuild();
        ...
        txtFeedback.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.putExtra(Intent.EXTRA_SUBJECT, "Hermes Moneymanager for Android: Feedback");
                try {
        ...
        clickListenerRate.setUrl("http://play.google.com/store/apps/details?id=org.financeapps.hermesmoneymanager");
        ...
        clickListenerIssuesTracker.setUrl("https://github.com/Hermes Moneymanager/android-money-manager-ex/issues/");
        txtIssues.setOnClickListener(clickListenerIssuesTracker);

        // hmm for Android web page
        ...
        clickListenerWebsite.setUrl("http://android.Hermes Moneymanager.org/");
        ...
        clickListenerFeedback.setUrl("http://www.Hermes Moneymanager.org/?utm_campaign=Application_Android&utm_medium=hmm_" + version + "&utm_source=Website");
        ...
        clickListenerGithub.setUrl("https://github.com/Hermes Moneymanager/android-money-manager-ex");
        ...
        clickListenerTwitter.setUrl("https://twitter.com/hmm4Android");
