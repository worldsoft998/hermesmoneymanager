package org.financeapps.hermesmoneymanager.core.database;
...
import org.financeapps.hermesmoneymanager.settings.DatabaseSettings;
...
public class DatabaseManager {
    ...
    private File getDbExternalStorageDirectory() {
        ...
        String defaultPath = externalStorageDirectory.getAbsolutePath()
                .concat(File.separator).concat("Hermes Moneymanager");
