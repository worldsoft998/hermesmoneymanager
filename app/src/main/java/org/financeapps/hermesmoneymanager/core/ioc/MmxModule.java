...
public final class MmxModule {
    private final hmmApplication application;

    public MmxModule(hmmApplication application) {
        this.application = application;
    }

    @Provides @Singleton
    hmmApplication provideApplication() {
        return application;
    }
...
//        return application.getSharedPreferences(PREFERENCES_FILE_NAME, 0);
    ...
    @Provides @Singleton
    AppSettings provideAppSettings(hmmApplication application) {
