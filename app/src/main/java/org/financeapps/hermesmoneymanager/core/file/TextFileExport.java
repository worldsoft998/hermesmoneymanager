 ...
 */
package org.financeapps.hermesmoneymanager.core.file;
...
//        File path = new File(this.context.getCacheDir(), ExportDirectory);
    ...
    private void offerFile(File file, String title) {
        //protected static final String ProviderAuthority = mContext.getApplicationContext().getPackageName() + "org.financeapps.hermesmoneymanager.fileprovider";
