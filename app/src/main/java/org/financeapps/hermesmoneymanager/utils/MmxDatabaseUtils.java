 ...
 */
package org.financeapps.hermesmoneymanager.utils;
...
import org.financeapps.hermesmoneymanager.domainmodel.Info;
import org.financeapps.hermesmoneymanager.home.DatabaseMetadata;
import org.financeapps.hermesmoneymanager.home.RecentDatabasesProvider;
...
import static org.financeapps.hermesmoneymanager.Constants.DEFAULT_DB_FILENAME;
...
public class MmxDatabaseUtils {
    ...
    public boolean useDatabase(@NonNull DatabaseMetadata database) {
        ...
        hmmApplication.getApp().initDb(database.localPath);
