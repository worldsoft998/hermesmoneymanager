 ...
 */
package org.financeapps.hermesmoneymanager;
...
import org.financeapps.hermesmoneymanager.common.MoneyParcelConverter;
...
import org.financeapps.hermesmoneymanager.core.ioc.DaggerMmxComponent;
import org.financeapps.hermesmoneymanager.core.ioc.MmxComponent;
import org.financeapps.hermesmoneymanager.core.ioc.MmxModule;
...
import org.financeapps.hermesmoneymanager.log.DebugTree;
import org.financeapps.hermesmoneymanager.log.ScreenTree;
import org.financeapps.hermesmoneymanager.log.SysLogTree;
...
import org.financeapps.hermesmoneymanager.sync.jobmanager.SyncJobCreator;
import org.financeapps.hermesmoneymanager.view.RobotoView;
...
public class HmmApplication
    ...
    private static hmmApplication appInstance;
    private static float mTextSize;
    private static String userName = "";

    public static hmmApplication getApp() {
        return appInstance;
    }

    public static float getTextSize() {
        return hmmApplication.mTextSize;
    }

    public static void setTextSize(float textSize) {
        hmmApplication.mTextSize = textSize;
    }
...
//        MultiDex.install(this);
    ...
    public boolean setUserName(String userName, boolean save) {
        hmmApplication.userName = userName;
...
//    }
    ...
    */
    ...
    private void registerCustomFonts() {
        String iconFontPath = "fonts/hmm.ttf";
