...
import org.financeapps.hermesmoneymanager.passcode.FingerprintHandler;
...
public class PasscodeActivity extends AppCompatActivity {
	...
	public static final String INTENT_REQUEST_PASSWORD = "org.financeapps.hermesmoneymanager.custom.intent.action.REQUEST_PASSWORD";
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.JELLY_BEAN) {
			...
			if (!fingerprintManager.isHardwareDetected()) {
				...
				((org.financeapps.hermesmoneymanager.view.RobotoTextView) findViewById(R.id.fingerprintInfo))
