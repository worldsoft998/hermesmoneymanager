 ...
 */
package com.mikepenz.hmm_icon_font_typeface_library;
...
public class MMXIconFont implements ITypeface {
    private static final String TTF_FILE = "hmm.ttf";
    ...
    public String getAuthor() {
        return "Hermes Moneymanager Project";
    }

    @Override
    public String getUrl() {
        return "https://android.financeapps.org";
    }

    @Override
    public String getDescription() {
        return "hmm 4 Android custom icon font";
    }
